...
name: figma-craft
description: |
  Figma 设计稿到 React 代码的智能转换工具。自动适配项目规范，智能匹配 Design Tokens，生成符合 XX 项目标准的代码。

  核心能力：
  - 智能样式映射：自动将 Figma 样式值匹配到项目 Token 系统
  - 组件智能选择：自动选用项目中的 指定组件库的 和 XX项目封装好的组件
...
- **路由配置**（config.route.js）：使用项目路由工具，返回路由对象
